...
p2 = function(p){
  fr2 = function(x){(12*(0.05*x[1]*(1-x[1]/150000)-p*x[1]*x[2]) +
                       6*(0.08*x[2]*(1-x[2]/400000)-p*x[1]*x[2]))*(-1)
  }
  c = c(50000,50000)
  ans = multi.V(c,Rev)
  return(ans)
...
result = data.frame(interaction_value = p, x1 = ans.x1, x2 = ans.x2, rev = ans.rev)
print(result)
